...
s21_decimal s21_binary_addition(s21_decimal decimal1, s21_decimal decimal2) {
  ...
  while (!s21_binary_equal_zero(tmp)) {
    s21_decimal overflow_bits = s21_binary_and(result, tmp);
    overflow_bits = s21_binary_shift_left(overflow_bits, 1);
...
s21_big_decimal s21_big_decimal_binary_addition(s21_big_decimal decimal1,
  ...
  s21_big_decimal result = decimal1;
  s21_big_decimal tmp = decimal2;

  while (!s21_binary_equal_zero(tmp.decimals[0]) ||
         !s21_binary_equal_zero(tmp.decimals[1])) {
    s21_big_decimal overflow_bits;
    overflow_bits.decimals[0] =
        s21_binary_and(result.decimals[0], tmp.decimals[0]);
    overflow_bits.decimals[1] =
        s21_binary_and(result.decimals[1], tmp.decimals[1]);

    overflow_bits = s21_big_decimal_binary_shift_left(overflow_bits, 1);
    result.decimals[0] = s21_binary_xor(result.decimals[0], tmp.decimals[0]);
    result.decimals[1] = s21_binary_xor(result.decimals[1], tmp.decimals[1]);
...
int s21_big_decimal_binary_compare(s21_big_decimal d1, s21_big_decimal d2) {
  int compare = s21_binary_compare(d1.decimals[1], d2.decimals[1]);

  if (compare == 0) {
    compare = s21_binary_compare(d1.decimals[0], d2.decimals[0]);
  }
...
s21_decimal s21_binary_division(s21_decimal decimal1, s21_decimal decimal2,
  ...
  if (s21_binary_equal_zero(decimal1)) {
    ...
    s21_decimal shifted_divisor = s21_binary_shift_left(decimal2, shift);
    ...
    while (shift >= 0) {
      if (need_subtraction == 1) {
        partial_remainder = s21_binary_subtraction(dividend, shifted_divisor);
      } else {
        partial_remainder = s21_binary_addition(dividend, shifted_divisor);
      }

      quotient = s21_binary_shift_left(quotient, 1);
      if (s21_decimal_is_set_bit(partial_remainder, MAX_BITS - 1) == 0) {
        quotient = s21_decimal_set_bit(quotient, 0);
      }

      dividend = s21_binary_shift_left(partial_remainder, 1);
    ...
    if (s21_decimal_is_set_bit(partial_remainder, MAX_BITS - 1)) {
      partial_remainder =
          s21_binary_addition(partial_remainder, shifted_divisor);
    }
    partial_remainder =
        s21_binary_shift_right(partial_remainder, left1 - left2);
  }
...
s21_big_decimal s21_big_decimal_binary_division(s21_big_decimal decimal1,
  ...
  if (s21_binary_equal_zero(decimal1.decimals[0]) &&
      s21_binary_equal_zero(decimal1.decimals[1])) {
    quotient = s21_create_big_decimal_from_decimal(s21_decimal_get_zero());
    partial_remainder =
        s21_create_big_decimal_from_decimal(s21_decimal_get_zero());
  } else if (s21_big_decimal_binary_compare(decimal1, decimal2) == -1) {
    quotient = s21_create_big_decimal_from_decimal(s21_decimal_get_zero());
    partial_remainder = decimal1;
  } else {
    ...
    s21_big_decimal shifted_divisor =
        s21_big_decimal_binary_shift_left(decimal2, shift);
    ...
    while (shift >= 0) {
      if (need_subtraction == 1) {
        partial_remainder =
            s21_big_decimal_binary_subtraction(dividend, shifted_divisor);
      } else {
        partial_remainder =
            s21_big_decimal_binary_addition(dividend, shifted_divisor);
      }
      ...
      dividend = s21_big_decimal_binary_shift_left(partial_remainder, 1);
    ...
    if (s21_decimal_is_set_bit(partial_remainder.decimals[1], MAX_BITS - 1)) {
      partial_remainder =
          s21_big_decimal_binary_addition(partial_remainder, shifted_divisor);
    }
    partial_remainder =
        s21_big_decimal_binary_shift_right(partial_remainder, left1 - left2);
  }
...
s21_big_decimal s21_binary_multiplication(s21_decimal decimal1,
  ...
  s21_big_decimal big_decimal_result =
      s21_create_big_decimal_from_decimal(s21_decimal_get_zero());
  s21_big_decimal big_decimal_tmp1 =
      s21_create_big_decimal_from_decimal(decimal1);
  ...
  for (int i = 0; i <= max_bit; i++) {
    if (s21_decimal_is_set_bit(decimal2, i) != 0) {
      big_decimal_result =
          s21_big_decimal_binary_addition(big_decimal_result, big_decimal_tmp1);
    }
    big_decimal_tmp1 = s21_big_decimal_binary_shift_left(big_decimal_tmp1, 1);
  }
...
s21_big_decimal s21_big_decimal_binary_multiplication(s21_big_decimal decimal1,
  ...
  s21_big_decimal big_decimal_result =
      s21_create_big_decimal_from_decimal(s21_decimal_get_zero());
  s21_big_decimal big_decimal_tmp1 = decimal1;
...
s21_decimal s21_binary_shift_left(s21_decimal decimal, int shift) {
  ...
  while (shift > 0) {
    result = s21_binary_shift_left_one(result);
    --shift;
  }
...
s21_decimal s21_binary_shift_right(s21_decimal decimal, int shift) {
  s21_decimal result = decimal;
  while (shift > 0) {
    result = s21_binary_shift_right_one(result);
    --shift;
  }
...
s21_big_decimal s21_big_decimal_binary_shift_left(s21_big_decimal decimal,
  ...
  while (shift > 0) {
    ...
    result.decimals[0] = s21_binary_shift_left_one(result.decimals[0]);
    result.decimals[1] = s21_binary_shift_left_one(result.decimals[1]);
    if (b0) {
...
s21_big_decimal s21_big_decimal_binary_shift_right(s21_big_decimal decimal,
  ...
  while (shift > 0) {
    ...
    result.decimals[0] = s21_binary_shift_right_one(result.decimals[0]);
    result.decimals[1] = s21_binary_shift_right_one(result.decimals[1]);
    if (b1) {
      result.decimals[0] =
...
s21_decimal s21_binary_subtraction(s21_decimal decimal1, s21_decimal decimal2) {
  s21_decimal result;
  decimal2 = s21_binary_not(decimal2);
  decimal2 = s21_binary_addition(decimal2, s21_decimal_get_one());
  result = s21_binary_addition(decimal1, decimal2);
...
s21_big_decimal s21_big_decimal_binary_subtraction(s21_big_decimal decimal1,
                                                   s21_big_decimal decimal2) {
  s21_big_decimal result;
  decimal2.decimals[0] = s21_binary_not(decimal2.decimals[0]);
  decimal2.decimals[1] = s21_binary_not(decimal2.decimals[1]);

  s21_big_decimal one =
      s21_create_big_decimal_from_decimal(s21_decimal_get_one());

  decimal2 = s21_big_decimal_binary_addition(decimal2, one);
  result = s21_big_decimal_binary_addition(decimal1, decimal2);
