...
Suite *suite_s21_is_greater_or_equal_ste(void) {
    Suite *s;
    TCase *tc;
    s = suite_create("s21_is_not_greater");
    tc = tcase_create("case_is_not_greater");

    tcase_add_loop_test(tc, s21_is_greater_or_equal_test_1, 0, 1000);
    tcase_add_loop_test(tc, s21_is_greater_or_equal_test_2, 0, 1000);
    tcase_add_test(tc, s21_is_greater_or_equal_test_3);
    tcase_add_loop_test(tc, s21_is_greater_or_equal_test_4, 0, 1000);
