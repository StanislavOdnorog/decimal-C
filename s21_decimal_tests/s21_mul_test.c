...
Suite *suite_s21_mul_ste(void) {
    ...
    // tcase_add_loop_test(tc, s21_mul_tests_1, 0, 1);
    // tcase_add_loop_test(tc, s21_mul_tests_2, 0, 10);
    // tcase_add_loop_test(tc, s21_mul_tests_3, 0, 1);
    // tcase_add_loop_test(tc, s21_mul_tests_4, 0, 1);
    tcase_add_loop_test(tc, s21_mul_tests_5, 0, 1);
    // tcase_add_loop_test(tc, s21_mul_tests_4, 0, 1000);
    // tcase_add_loop_test(tc, s21_mul_tests_5, 0, 1000);
    // tcase_mul_test(tc, s21_mul_tests_6);
